...
export const ru = {
  ...
  buttons: {
    ...
    // ---------Task Menu---------
    increase_speed: '📈 Увеличение скорости',
    instant_earning: '💸 Моментальный заработок',
    // ---------Admin Menu---------
  ...
  mining: {
    ...
    action: 'Чтобы начать зарабатывать, подпишитесь на следующие каналы, активируйте Chat AI Bot и вернувшись сюда нажмите кнопку "Готово":',
    done: '✅ Майнинг активен',
    mined: 'Намайнено:',
    rate: '⛏️ Каждые 5 секунд вы получаете:',
    increase: '💡Чтобы увеличить скорость выполняйте доступные 📂Задания',
  ...
  tasks: {
    admin_message: 'Меню управления заданиями',
    user_message: 'Меню выбора заданий',
    list: {
    ...
    create: {
      message: 'Какое задание хочешь создать?',
      notification: {
      ...
      buttons: {
        ...
        [TasksEnum.TG_COMMENT]: 'Комменты ТГ',
      ...
      questions: {
        ...
        reward: {
          message: 'Выберите вознаграждение за выполнение задания',
          error: '',
        },
        increase_mining_rate: {
          message: 'Выберите майнинг-рейт за выполнение задания',
          error: '',
        },
        available_limit: {
  ...
  users: {
    ...
    payroll: {
      notification: 'Поздравляем! Вам начислено',
      input: {
        title: 'Введите сумму в TON (пример 0.005)',
        success: 'Вы начислили юзеру {{amount}} TON. Его баланс сейчас составляет:',
        error: 'Пополнение не удалось',
      },
    },
  },
  referral: {
